...
commands = [
    ...
    "gcc -c src/Modules/io.c -o build/io.o -std=c99 -O2 -Wall -Wextra -fno-builtin -nostdlib",
    "ld build/boot.o build/kernel.o build/vga.o build/io.c -T linker.ld -o kernel -O2 -nostdlib"
]
