...
LD_FILES=build/boot.o build/kernel.o build/vga.o build/keyboard.o build/memory.o build/string.o build/shell.o build/sata.o
LD_FLAGS=-m elf_i386 -T linker.ld -o kirid.bin -O2 -nostdlib

all: clear Kirid

Kirid: boot.o kernel.o keyboard.o memory.o string.o vga.o shell.o sata.o
...
#Drivers########################################################
sata.o:
	gcc kernel/Drivers/SATA/sata.c -o build/sata.o $(GCC_FLAGS)
