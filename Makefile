...
LD_FILES=build/boot.o build/kernel.o build/vga.o build/keyboard.o build/memory.o build/string.o build/shell.o build/disk.o
LD_FLAGS=-m elf_i386 -T linker.ld -o kirid -O2 -nostdlib

all: clear Kirid

Kirid: boot.o kernel.o keyboard.o memory.o string.o vga.o shell.o disk.o
...
disk.o:
	gcc kernel/Source/disk.c -o build/disk.o $(GCC_FLAGS)
############################################################
